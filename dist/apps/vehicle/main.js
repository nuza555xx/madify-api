...
/***/ "./src/app/dto/vehicle.dto.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


var _a;
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.GetSearchVehicleQuery = void 0;
...
], GetSearchVehicleQuery.prototype, "search", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        name: 'skip',
        example: '',
...
], GetSearchVehicleQuery.prototype, "skip", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        name: 'limit',
        example: 5,
    ...
    (0, class_transformer_1.Type)(() => Number),
    tslib_1.__metadata("design:type", Number)
], GetSearchVehicleQuery.prototype, "limit", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        name: 'sorting',
        example: database_1.Sorting.ASC,
        description: 'This is a required property',
        required: false,
        enum: database_1.Sorting,
    }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEnum)(database_1.Sorting),
    tslib_1.__metadata("design:type", typeof (_a = typeof database_1.Sorting !== "undefined" && database_1.Sorting) === "function" ? _a : Object)
], GetSearchVehicleQuery.prototype, "sorting", void 0);
exports.GetSearchVehicleQuery = GetSearchVehicleQuery;


/***/ }),

/***/ "./src/app/service/vehicle.abstract.ts":
...
let VehicleImpl = class VehicleImpl {
    ...
    createVehicle(body, accountId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const vehicle = yield this.repository.createVehicle(Object.assign(Object.assign({}, body), { accountId: accountId }));
            if (!vehicle)
    ...
    listVehicle(_a) {
        var { skip = 0, limit } = _a, query = tslib_1.__rest(_a, ["skip", "limit"]);
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const queryOptions = {
                skip: skip,
                limit: limit,
            };
            const vehicles = yield this.repository.findVehicles(Object.assign({}, query), queryOptions);
...
VehicleImpl = tslib_1.__decorate([
...
const common_1 = __webpack_require__("@nestjs/common");
const vehicle_dto_1 = __webpack_require__("./src/app/dto/vehicle.dto.ts");
const vehicle_abstract_1 = __webpack_require__("./src/app/service/vehicle.abstract.ts");
...
tslib_1.__decorate([
    ...
    (0, decorator_1.MadifySharedCached)(config_1.RedisCacheKey.VEHICLE),
    tslib_1.__param(0, (0, common_1.Query)()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [typeof (_b = typeof vehicle_dto_1.GetSearchVehicleQuery !== "undefined" && vehicle_dto_1.GetSearchVehicleQuery) === "function" ? _b : Object]),
    tslib_1.__metadata("design:returntype", void 0)
], VehicleController.prototype, "listVehicle", null);
VehicleController = tslib_1.__decorate([
    (0, decorator_1.MadifyController)({ path: config_1.APIPrefix.VEHICLE }),
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof vehicle_abstract_1.VehicleService !== "undefined" && vehicle_abstract_1.VehicleService) === "function" ? _a : Object])
], VehicleController);
...
const common_1 = __webpack_require__("@nestjs/common");
const vehicle_abstract_1 = __webpack_require__("./src/app/service/vehicle.abstract.ts");
const vehicle_service_1 = __webpack_require__("./src/app/service/vehicle.service.ts");
const vehicle_controller_1 = __webpack_require__("./src/app/vehicle.controller.ts");
...
VehicleModule = tslib_1.__decorate([
    (0, common_1.Module)({
        ...
        providers: [
            {
                provide: vehicle_abstract_1.VehicleService,
                useClass: vehicle_service_1.VehicleImpl,
            },
        ],
    })
], VehicleModule);
...
const vehicle_module_1 = __webpack_require__("./src/app/vehicle.module.ts");
function bootstrap() {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const prefix = config_1.APIPrefix.VEHICLE;
        const port = process.env.PORT || 5003;
        const fastifyAdapter = new platform_fastify_1.FastifyAdapter();
        const app = yield core_1.NestFactory.create(vehicle_module_1.VehicleModule, fastifyAdapter);
        app.enableCors();
